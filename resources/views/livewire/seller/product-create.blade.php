<div>
    <div class="mb-8">
        ...
        <p class="text-gray-600 mt-2">Isi informasi lengkap produk yang ingin dijual</p>
    </div>

    <form wire:submit="createProduct" class="bg-white rounded-lg shadow-md p-8 space-y-8">
        <!-- Basic Info Section -->
        ...
        <div class="bg-blue-50 border border-blue-200 rounded-lg p-6">
            <h3 class="font-semibold text-blue-900 mb-3">💡 Tips Menjual</h3>
            <ul class="text-sm text-blue-800 space-y-2">
                <li>✓ Gunakan nama produk yang jelas dan deskriptif</li>
                <li>✓ Jelaskan keunggulan dan spesifikasi produk secara detail</li>
                <li>✓ Tetapkan harga yang kompetitif</li>
                <li>✓ Gunakan gambar berkualitas tinggi dari sumber terpercaya</li>
            </ul>
        </div>
